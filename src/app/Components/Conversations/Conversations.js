...
const Conversations = () => {
  return (
    <section className="relative  py-20 lg:px-20 bg-gray-900  md:py-24 bg-body overflow-hidden">
      <Image
        className=" lg:block  lg:translate-x-[250px]  rotate-180 absolute inset-0 h-screen lg:h-full w-full "
        src="/bgline.svg"
        width="1000"
        height="617"
        alt="Bg Lines"
      ...
      <Image
        className=" md:block z-10 absolute top-40 left-0 mt-24 ml-4 lg:ml-24 xl:ml-64   animate-spin"
        width="111"
        height="110"
        src="/blink-star.png"
        alt="Blink Star"
      ...
      <div className="relative container mx-auto px-4">
        <div className="absolute bottom-0 left-0 -mb-20 w-160 h-160 bg-gradient-to-t from-purple-700 to-darkBlue-900 rounded-full filter blur-4xl"></div>
        <div className="absolute bottom-0 right-0 -mb-20 w-148 h-148 bg-gradient-to-t from-violet-900 to-darkBlue-900 rounded-full filter blur-4xl"></div>
        <div className="relative">
          <div className="max-w-xl mx-auto mb-16 text-center">
            <h2 className=" text-4xl lg:text-5xl text-white font-bold tracking-tight mb-4">
              Intelligent Conversations
            </h2>
            <p className="text-xl text-gray-400">
              Casper is powered by state-of-the-art <span className="text-[#53DD81] underline">artificial intelligence</span> and
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
              <div className="max-w-md mx-auto h-full p-8 rounded-3xl shadow-box-violet overflow-hidden bg-white bg-opacity-10">
                ...
                <p className="text-xl text-gray-400">
                  Powered by state-of-the-art <span className="text-[#53DD81]">artificial intelligence,</span> ensuring
