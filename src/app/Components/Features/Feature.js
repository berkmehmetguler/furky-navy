  ...
  return (
    <section class="relative bg-[#111827]  lg:px-20 py-12 sm:pt-24 bg-body overflow-hidden">
      <Image
        ...
        width="470"
        height="695"
        alt="Double Line Circle"
      />
      <div class="relative container mx-auto ">
        <div class="flex flex-wrap items-end ">

            <div class="w-full lg:w-1/2 px-4 mb-20  lg:mb-0">
                <div class="max-w-lg mx-auto lg:mx-0 lg:max-w-none pb-32">
                <span class="inline-flex underline items-center px-3.5 h-7 mb-8 text-md font-medium text-[#53DD81] leading-6 bg-gradient-tag rounded-full">
                    FEATURES:
                </span>
                ...
                <div class="flex mb-16 items-start">
                    ...
                    <p class="text-lg text-gray-600 tracking-tight">
                        Adapts to each user & personalized recommendation
                    </p>
                    </div>
                </div>
            ...
            <div class="w-full lg:w-1/2 px-4">
                ...
                <Image
                    class="absolute  top-10 right-0 -mt-40 md:-mr-12  animate-spin "
                    src="/blink-star.png"
                    width="111"
                    height="110"
                    alt="Image 2"
